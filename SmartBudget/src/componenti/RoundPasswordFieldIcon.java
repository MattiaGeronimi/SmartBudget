...
public class RoundPasswordFieldIcon extends RoundPasswordField {

    private Image immagineIcona;
    private int distanzaIcona = 15;
    double spazioOccupato = 0.40;
    
    public RoundPasswordFieldIcon() {
        super();
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (immagineIcona != null) {
            Graphics2D graficaPasswordFieldIcon = (Graphics2D) g.create();
            graficaPasswordFieldIcon.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            ...
            graficaPasswordFieldIcon.drawImage(immagineIcona, distanzaIcona, y, larghezzaIcona, altezzaIcona, null);
            graficaPasswordFieldIcon.dispose();
        }
    }
